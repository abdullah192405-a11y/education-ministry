...
import { Play, Users, Zap, ArrowLeft, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">{t("hero.studentsCount")}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-black text-secondary">12</p>
              <p className="text-sm text-muted-foreground mt-1">{t("hero.gradesCount")}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-black text-success">+50</p>
              <p className="text-sm text-muted-foreground mt-1">{t("hero.subjectsCount")}</p>
            </div>
          </motion.div>
        </div>
      </div>
