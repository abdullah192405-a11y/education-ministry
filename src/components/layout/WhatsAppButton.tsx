  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col items-center gap-2">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-colors hover:bg-[#128C7E] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
