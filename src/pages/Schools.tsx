        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground text-lg">استكشف المدارس ومحتوى كل مدرسة.</p>
            </div>
            <Badge variant="outline" className="text-sm">
              {schoolCards.length} مدرسة
            </Badge>
          </motion.div>
          ...
          {(isLoadingOrgs || isLoadingGrades) ? (
            ...
            <p className="text-center text-muted-foreground py-12">لا توجد مدارس منشورة حالياً.</p>
          ) : (
                ...
                <Link key={org.id} to={`/org/${org.slug}`}>
                  <div className="p-2 text-center space-y-3 transition-transform hover:-translate-y-0.5">
                      ...
                      <div className="space-y-1">
                        ...
                        <Badge variant="secondary" className="text-[10px]">مدرسة</Badge>
                      </div>
